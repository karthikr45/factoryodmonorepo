  ...
  return (
    <div>
      ...
      <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Link href="/factory/money/aged" className="group rounded-lg border border-neutral-200 bg-white p-6 transition hover:border-brand-300 hover:shadow-sm">
          <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-brand-50 text-xl">⏳</div>
          <h2 className="mt-4 text-lg font-semibold text-brand-900 group-hover:text-brand-700">Aged report</h2>
          <p className="mt-1 text-sm text-neutral-600">Receivables and payables by age bucket</p>
        </Link>

        <Link href="/factory/money/expenses" className="group rounded-lg border border-neutral-200 bg-white p-6 transition hover:border-brand-300 hover:shadow-sm">
          <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-brand-50 text-xl">🧾</div>
          <h2 className="mt-4 text-lg font-semibold text-brand-900 group-hover:text-brand-700">Expenses</h2>
          <p className="mt-1 text-sm text-neutral-600">Rent, utilities, travel — anything that isn&rsquo;t a PO</p>
        </Link>
      </div>
    </div>
  );
